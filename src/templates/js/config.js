var config = {
    ...
    coinUnitPlaces: 12,
    txMinConfirms: 10,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in Electroneum
    txCoinbaseMinConfirms: 60, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in Electroneum
    coinSymbol: 'ETN',
    openAliasPrefix: "etn",
    coinName: 'Electroneum',
    coinUriPrefix: 'electroneum:',
    addressPrefix: 18,
